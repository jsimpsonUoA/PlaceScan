 ...
 *     cdef char[:, ::1] path = np.empty((len(list1)+1, len(list2)+1), dtype='uint8')
 */
  __pyx_tuple__22 = PyTuple_Pack(9, __pyx_n_s_list1, __pyx_n_s_list2, __pyx_n_s_alpha, __pyx_n_s_costs, __pyx_n_s_path, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_index1, __pyx_n_s_index2); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(3, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dtw_dtw_pyx, __pyx_n_s_dtw, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 6, __pyx_L1_error)
