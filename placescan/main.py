...
class PlaceScan():
    ...
    def wiggle_plot(self, normed=True, bandpass=None, dc_corr_seconds=None,
                    ...
                    plot_picks=False, decimate=False, pick_type='p', **kwargs):
        '''
    ...
    def trace_comparison(self, normed=False, bandpass=None, dc_corr_seconds=None,
                        ...
                        save_ext='', tmin=0.0, tmax=None, plot_picks=False, labels=None,
                         show=True, fig=None, inset_params=None, **kwargs):
        '''
        Create an animated GIF of plots from different scans for easy
        comparison.
        ...
        if not spread_traces:
            ...
            fig = plot.spread_waveform_plot(values, plot_times, spread_values, 
                  tmax=tmax,plot_picks_dir=None, pick_errors=None, picks_offset=0.,
                  picks_kwargs={}, save_dir=save_dirs, labels=labels, show=show, fig=fig, **kwargs)
